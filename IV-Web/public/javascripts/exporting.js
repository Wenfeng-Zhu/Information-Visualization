...
(function(e) {
    ...
    e = e ? e._modules: {};
    q(e, "Extensions/FullScreen.js", [e["Core/Chart/Chart.js"], e["Core/Globals.js"], e["Core/Utilities.js"]],
    function(e, l, g) {
        var k = g.addEvent;
        g = function() {
            function e(f) {
            ...
            e.prototype.open = function() {
                ...
                e = f.chart;
                if (f.browserProps) {
                    f.unbindFullscreenEvent = k(e.container.ownerDocument, f.browserProps.fullscreenChange,
                    function() {
            ...
            e.prototype.setButtonText = function() {
                ...
                f = e.options.lang; (null === k || void 0 === k ? 0 : k.menuItemDefinitions) && (null === f || void 0 === f ? 0 : f.exitFullscreen) && f.viewFullscreen && l && g && g.length && (g[l.indexOf("viewFullscreen")].innerHTML = this.isOpen ? f.exitFullscreen: k.menuItemDefinitions.viewFullscreen.text || f.viewFullscreen)
            };
    ...
    q(e, "Extensions/Exporting.js", [e["Core/Chart/Chart.js"], e["Mixins/Navigation.js"], e["Core/Globals.js"], e["Core/Options.js"], e["Core/Renderer/SVG/SVGRenderer.js"], e["Core/Utilities.js"]],
        ...
        z(e.prototype, {
            ...
            contextMenu: function(a, b, c, d, e, g, k) {
                ...
                if (!m) {
                    ...
                    h.exportEvents.push(v(m, "mouseleave",
                    function() {
                    ...
                    b.forEach(function(a) {
                        ...
                        if (J(a, !0)) {
                            ...
                            else "viewData" === a.textKey && h.isDataTableVisible && (a.textKey = "hideData"),
                            b = x("li", {
                            ...
                            null, p),
                            h.styledMode || (b.onmouseover = function() {
    ...
    q(e, "masters/modules/exporting.src.js", [],
    function() {})
});
