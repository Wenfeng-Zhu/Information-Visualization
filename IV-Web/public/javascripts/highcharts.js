...
*/
(function(X, N) {
    "object" === typeof module && module.exports ? (N["default"] = N, module.exports = X.document ? N(X) : N) : "function" === typeof define && define.amd ? define("highcharts/highcharts",
    function() {
        return N(X)
...
function(X) {
    ...
    N(m, "Core/Utilities.js", [m["Core/Globals.js"]],
    function(f) {
        function h(b, k, t, a) {
        ...
        function m() {
            ...
            a = function(b, k) {
                "object" !== typeof b && (b = {});
                S(k,
                function(t, u) { ! z(t, !0) || n(t) || D(t) ? b[u] = k[u] : b[u] = a(b[u] || {},
                    t)
                });
                return b
        ...
        function F(b, k, t) {
            var a;
            v(k) ? w(t) ? b.setAttribute(k, t) : b && b.getAttribute && ((a = b.getAttribute(k)) || "class" !== k || (a = b.getAttribute(k + "Name"))) : S(k,
            function(k, t) {
                b.setAttribute(t, k)
            });
            return a
        ...
        function K(b, k) {
            ...
            for (b = t.pop();
            "undefined" !== typeof b && "undefined" !== typeof k && null !== k;) k = k[b],
            b = t.pop();
            return k
        }
        f.timers = [];
        ...
        var U = f.getStyle = function(b, k, t) {
            if ("width" === k) return k = Math.min(b.offsetWidth, b.scrollWidth),
            ...
            if (b = e.getComputedStyle(b, void 0)) b = b.getPropertyValue(k),
            L(t, "opacity" !== k) && (b = I(b));
            return b
        },
        ...
        W = f.removeEvent = function(b, k, t) {
            ...
            var c; ["protoEvents", "hcEvents"].forEach(function(H, d) {
        ...
        ia = f.setOptions = function(b) {
            f.defaultOptions = m(!0, f.defaultOptions, b); (b.time || b.global) && f.time.update(m(f.defaultOptions.global, f.defaultOptions.time, b.global, b.time));
            return f.defaultOptions
        };
    ...
    N(m, "Core/Color/Color.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.isNumber,
        z = h.merge,
        F = h.pInt;
        ...
        h = function() {
            ...
            h.prototype.init = function(f) {
                ...
                if ((this.input = f = h.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops) this.stops = f.stops.map(function(v) {
                    ...
                    if (!C) for (y = this.parsers.length; y--&&!C;) {
                        var I = this.parsers[y]; (e = I.regex.exec(f)) && (C = I.parse(e))
                    }
                }
                this.rgba = C || []
            };
            ...
            h.prototype.brighten = function(f) {
                ...
                else if (m(f) && 0 !== f) for (h = 0; 3 > h; h++) y[h] += F(255 * f),
                0 > y[h] && (y[h] = 0),
                255 < y[h] && (y[h] = 255);
                return this
            };
    ...
    N(m, "Core/Animation/Fx.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = f.win,
        z = h.isNumber,
        F = h.objectEach;
        h = function() {
            ...
            h.prototype.step = function(f) {
                ...
                if (e.attr && !e.element) f = !1;
                    ...
                    D && I && I.call(e);
                    f = !1
                } else this.pos = y.easing((h - this.startTime) / v),
    ...
    N(m, "Core/Animation/AnimationUtilities.js", [m["Core/Animation/Fx.js"], m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        var z = m.defined,
        P = m.getStyle,
        L = m.isArray,
        ...
        x = h.getDeferredAnimation = function(l, n, w) {
            var r = v(n),
            d = 0,
            g = 0; (w ? [w] : l.series).forEach(function(c) {
    ...
    N(m, "Core/Renderer/SVG/SVGElement.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h, m, z) {
        var F = f.animate,
        P = f.animObject,
        K = f.stop,
        ...
        f = function() {
            ...
            E.prototype.addClass = function(a, b) {
                ...
                a = (a || "").split(/ /g).reduce(function(b, a) { - 1 === k.indexOf(a) && b.push(a);
                    return b
                },
                k ? [k] : []).join(" ");
            ...
            E.prototype.align = function(a, b, k) {
                ...
                var p, q;
                if (a) {
                    if (this.alignOptions = a, this.alignByTranslate = b, !k || B(k)) this.alignTo = t = k || "renderer",
                    d(g, this),
                    g.push(this),
                    k = void 0
            ...
            E.prototype.attr = function(a, b, k, t) {
                ...
                "string" === typeof a ? d = (this[a + "Getter"] || this._defaultGetter).call(this, a, c) : (G(a,
                function(b, k) {
                    g = !1;
                    t || K(this, k);
                    this.symbolName && -1 !== q.indexOf(k) && (u || (this.symbolAttr(a), u = !0), g = !0); ! this.rotation || "x" !== k && "y" !== k || (this.doTransform = !0);
            ...
            E.prototype.css = function(a) {
                ...
                if (d) {
                    ...
                    if (t.namespaceURI === this.SVG_NS) {
                        ...
                        G(a,
                        function(b, k) { - 1 === u.indexOf(k) && (c += k.replace(/([A-Z])/g, q) + ":" + b + ";")
                        });
                        c && l(t, "style", c)
                    } else w(t, a);
            ...
            E.prototype.destroy = function() {
                ...
                K(a);
                if (a.clipPath && c) {
                    var g = a.clipPath; [].forEach.call(c.querySelectorAll("[clip-path],[CLIP-PATH]"),
                    function(b) { - 1 < b.getAttribute("clip-path").indexOf(g.element.id) && b.removeAttribute("clip-path")
                    });
                ...
                a.safeRemoveChild(b);
                for (k.styledMode || a.destroyShadows(); t && t.div && 0 === t.div.childNodes.length;) b = t.parentGroup,
            ...
            E.prototype.destroyShadows = function() { (this.shadows || []).forEach(function(a) {
            ...
            E.prototype.getBBox = function(a, b) {
                ...
                if (!k) {
                    if (A || t.forExport) {
                        try {
                            var w = this.fakeTS &&
                            function(b) { [].forEach.call(c.querySelectorAll(".highcharts-text-outline"),
                                function(k) {
                                    k.style.display = b
                                })
                            };
            ...
            E.prototype.on = function(a, b) {
                ...
                c.ontouchend = function(a) {
                    ...
                    d = !0; ! 1 !== a.cancelable && a.preventDefault()
                },
            ...
            E.prototype.removeTextOutline = function(a) {
                for (var b = a.length,
                k; b--;) k = a[b],
                "highcharts-text-outline" === k.getAttribute("class") && d(a, this.element.removeChild(k))
            };
            ...
            E.prototype.setTextPath = function(a, b) {
                ...
                if (a && b && b.enabled) {
                    ...
                    var u = d.element; (b = a.element.getAttribute("id")) || a.element.setAttribute("id", b = O());
                    if (g) for (a = k.getElementsByTagName("tspan"); a.length;) a[0].setAttribute("y", 0),
            ...
            E.prototype.shadow = function(a, b, k) {
                ...
                var u; ! 0 === a ? u = q: "object" === typeof a && (u = g(q, a));
                u && (u && p && G(u,
                function(b, k) {
                    b !== p[k] && (d = !0)
            ...
            E.prototype.updateTransform = function() {
                ...
                c ? a.push("rotate(90) scale(-1,1)") : d && a.push("rotate(" + d + " " + M(this.rotationOriginX, p.getAttribute("x"), 0) + " " + M(this.rotationOriginY, p.getAttribute("y") || 0) + ")"); (r(k) || r(t)) && a.push("scale(" + M(k, 1) + " " + M(t, 1) + ")");
            ...
            E.prototype.zIndexSetter = function(a, b) {
                ...
                this[b] = a;
                if (p) { (a = this.zIndex) && t && (t.handleZ = !0);
                    b = c.childNodes;
                    for (q = b.length - 1; 0 <= q && !g; q--) {
                        t = b[q];
                        p = t.getAttribute("data-z-index");
                        var u = !r(p);
                        if (t !== d) if (0 > a && u && !k && !q) c.insertBefore(d, b[q]),
                        g = !0;
                        else if (T(p) <= a || u && (!r(a) || 0 <= a)) c.insertBefore(d, b[q + 1] || null),
                        g = !0
                    }
    ...
    N(m, "Core/Renderer/SVG/SVGLabel.js", [m["Core/Renderer/SVG/SVGElement.js"], m["Core/Utilities.js"]],
    function(f, h) {
        ...
        return function(h) {
            ...
            e.prototype.css = function(h) {
                if (h) {
                    ...
                    if ("width" in v || I) this.updateBoxSize(),
                    I && this.updateTextPadding()
                }
            ...
            e.prototype.on = function(e, v) {
                ...
                if (n) {
                    var l = function(l) { ("mouseenter" === e || "mouseleave" === e) && l.relatedTarget instanceof Element && (h.element.contains(l.relatedTarget) || n.element.contains(l.relatedTarget)) || v.call(h.element, l)
                    };
                    n.on(e, l)
                }
    ...
    N(m, "Core/Renderer/SVG/SVGRenderer.js", [m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Renderer/SVG/SVGElement.js"], m["Core/Renderer/SVG/SVGLabel.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F) {
        var P = F.addEvent,
        K = F.attr,
        C = F.createElement,
        ...
        E = function() {
            ...
            u.prototype.buildText = function(b) {
                ...
                x = function(b, k) {
                    ...
                    a = b.indexOf(k + "=");
                    if ( - 1 !== a && (a = a + k.length + 1, k = b.charAt(a), '"' === k || "'" === k)) return b = b.substring(a + 1),
                    b.substring(0, b.indexOf(k))
                },
                I = /<br.*?>/g;
                    ...
                    q || f || V || e || -1 !== g.indexOf(" ") && (!E || I.test(g)) ? (n && n.appendChild(k), q ? (g = a.styledMode ? g.replace(/<(b|strong)>/g, '<span class="highcharts-strong">').replace(/<(i|em)>/g, '<span class="highcharts-emphasized">') : g.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">'), g = g.replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(I)) : g = [g], g = g.filter(function(b) {
                        ...
                        q.forEach(function(t) {
                            if ("" !== t || 1 === q.length) {
                                ...
                                n,
                                r; (n = x(t, "class")) && K(u, "class", n);
                                if (n = x(t, "style")) n = n.replace(/(;| |^)color([ :])/, "$1fill$2"),
                                K(u, "style", n);
                                ...
                                if (" " !== t) {
                                    ...
                                    if (e) {
                                        ...
                                        l = 0;
                                        r = O(u);
                                        if (V) A = a.truncate(b, u, t, void 0, 0, Math.max(0, e - parseInt(h || 12, 10)),
                                        function(b, k) {
                                            ...
                                            dy: r,
                                            x: B
                                        }), n && K(u, "style", n), u.appendChild(p.createTextNode(w.join(" ").replace(/- /g, "-"))), k.appendChild(u)),
                                        a.truncate(b, u, null, w, 0 === l ? H: 0, e,
                                        function(b, k) {
            ...
            u.prototype.button = function(b, k, a, c, d, g, p, q, u, n) {
                ...
                P(t.element, A ? "mouseover": "mouseenter",
                function() {
                    3 !== H && t.setState(1)
                });
                P(t.element, A ? "mouseout": "mouseleave",
                function() {
                    3 !== H && t.setState(H)
                });
            ...
            u.prototype.pathToSegments = function(b) {
                ...
                d = 0; d < b.length; d++) l(a[0]) && D(b[d]) && a.length === c[a[0].toUpperCase()] && b.splice(d, 0, a[0].replace("M", "L").replace("m", "l")),
    ...
    N(m, "Core/Renderer/HTML/HTMLElement.js", [m["Core/Globals.js"], m["Core/Renderer/SVG/SVGElement.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        var z = m.css,
        F = m.defined,
        P = m.extend,
        ...
        P(h.prototype, {
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    this.inverted && [].forEach.call(f.childNodes,
                    function(a) {
                        e.invertChild(a, f)
                    });
                    if ("SPAN" === f.tagName) {
                        ...
                        c; (c = d !== this.oldTextWidth) && !(c = d > this.oldTextWidth) && ((c = this.textPxLength) || (z(f, {
                            width: "",
                            whiteSpace: r || "nowrap"
    ...
    N(m, "Core/Renderer/HTML/HTMLRenderer.js", [m["Core/Globals.js"], m["Core/Renderer/SVG/SVGElement.js"], m["Core/Renderer/SVG/SVGRenderer.js"], m["Core/Utilities.js"]],
    function(f, h, m, z) {
        var F = f.isFirefox,
        P = f.isMS,
        K = f.isWebKit,
        ...
        I(m.prototype, {
            ...
            html: function(f, D, n) {
                ...
                w = l.renderer,
                r = w.isSVG,
                d = function(d, c) { ["opacity", "visibility"].forEach(function(a) {
    ...
    N(m, "Core/Axis/Tick.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.clamp,
        z = h.correctFloat,
        F = h.defined,
        ...
        h = function() {
            ...
            f.prototype.createLabel = function(n, l, f) {
                var w = this.axis,
                r = w.chart;
                if (n = F(l) && f.enabled ? r.renderer.text(l, n.x, n.y, f.useHTML).add(w.labelGroup) : null) r.styledMode || n.css(e(f.style)),
            ...
            f.prototype.moveLabel = function(n, e) {
                ...
                d = l.axis,
                g = d.reversed;
                w && w.textStr === n ? (l.movedLabel = w, r = !0, delete l.label) : I(d.ticks,
                function(a) {
    ...
    N(m, "Core/Time.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.defined,
        z = h.error,
        F = h.extend,
        ...
        h = function() {
            ...
            h.prototype.update = function(n) {
                ...
                this.options = n = K(!0, this.options || {},
                n);
            ...
            h.prototype.getTimeTicks = function(n, l, f, h) {
                ...
                if (m(l)) {
                    ...
                    l = c.getTime();
                    for (c = 1; l < f;) d.push(l),
                    l = a === v.year ? r.makeTime(B + c * q, 0) : a === v.month ? r.makeTime(B, h + c * q) : !p || a !== v.day && a !== v.week ? p && a === v.hour && 1 < q ? r.makeTime(B, h, A, w + c * q) : l + a * q: r.makeTime(B, h, A + c * q * (a === v.day ? 1 : 7)),
                    c++;
                    d.push(l);
    ...
    N(m, "Core/Options.js", [m["Core/Globals.js"], m["Core/Color/Color.js"], m["Core/Time.js"], m["Core/Utilities.js"]],
    function(f, h, m, z) {
    ...
    N(m, "Core/Axis/Axis.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Axis/Tick.js"], m["Core/Utilities.js"], m["Core/Options.js"]],
    function(f, h, m, z, F, L) {
        ...
        f = function() {
            ...
            u.prototype.defaultLabelFormatter = function() {
                ...
                else if (e && 1E3 <= b) for (; e--&&"undefined" === typeof A;) a = Math.pow(p, e + 1),
            ...
            u.prototype.getClosest = function() {
                ...
                this.categories ? b = 1 : this.series.forEach(function(a) {
                    ...
                    c = a.visible || !a.chart.options.chart.ignoreHiddenSeries; ! a.noSharedTooltip && x(k) && c && (b = x(b) ? Math.min(b, k) : k)
                });
                return b
            };
            ...
            u.prototype.updateNames = function() {
                ...
                0 < a.length && (Object.keys(a.keys).forEach(function(b) {
                    ...
                    a.xIncrement = null;
                    if (!a.points || a.isDirtyData) b.max = Math.max(b.max, a.xData.length - 1),
                    a.processData(),
                    a.generatePoints();
            ...
            u.prototype.setAxisTranslation = function(b) {
                ...
                if (B || e || d) {
                    ...
                    q ? (g = q.minPointOffset, p = q.pointRangePadding) : k.series.forEach(function(b) {
                        ...
                        d = Math.max(d, c);
                        if (!k.single || e) b = b.is("xrange") ? !B: B,
            ...
            u.prototype.setTickInterval = function(b) {
                ...
                a.adjustForMinRange(); ! (w || a.axisPointRange || a.stacking && a.stacking.usePercentage || u) && x(a.min) && x(a.max) && (d = a.max - a.min) && (!x(O) && l && (a.min -= d * l), !x(D) && B && (a.max += d * B));
                ...
                }) ? a.closestPointRange: 0); ! f && a.tickInterval < b && (a.tickInterval = b);
            ...
            u.prototype.alignToOthers = function() {
                var b = {},
                a, c = this.options; ! 1 === this.chart.options.chart.alignTicks || !1 === c.alignTicks || !1 === c.startOnTick || !1 === c.endOnTick || this.logarithmic || this.chart[this.coll].forEach(function(k) {
                    var c = k.options;
            ...
            u.prototype.getTickAmount = function() {
                var b = this.options,
                a = b.tickAmount,
                c = b.tickPixelInterval; ! x(b.tickInterval) && !a && this.len < c && !this.isRadial && !this.logarithmic && b.startOnTick && b.endOnTick && (a = 2); ! a && this.alignToOthers() && (a = Math.ceil(this.len / c) + 1);
            ...
            u.prototype.zoom = function(b, a) {
                ...
                function(b) {
                    var a = b.newMin,
                    g = b.newMax;
                    if (a !== k.min || g !== k.max) k.allowZoomOutside || (x(c) && (a < p && (a = p), a > q && (a = q)), x(d) && (g < p && (g = p), g > q && (g = q))),
            ...
            u.prototype.getOffset = function() {
                ...
                }), b.staggerLines && (G *= b.staggerLines), b.labelOffset = G * (b.opposite ? -1 : 1)) : B(p,
                function(b, a) {
                    b.destroy();
                    delete p[a]
                });
            ...
            u.prototype.renderTick = function(b, a) {
                ...
                if (!d || b >= this.min && b <= this.max || (null === (k = this.grid) || void 0 === k ? 0 : k.isColumn)) g[b] || (g[b] = new z(this, b)),
            ...
            u.prototype.render = function() {
                ...
                b.overlap = !1; [u, l, r].forEach(function(b) {
                    B(b,
                    function(b) {
                        b.isActive = !1
                    })
                ...
                }), b._addedPlotLB = !0); [u, l, r].forEach(function(b) {
                    var c, k = [],
                    d = w.duration;
                    B(b,
                    function(b, a) {
            ...
            u.prototype.destroy = function(b) {
                ...
                b || M(a); [a.ticks, a.minorTicks, a.alternateBands].forEach(function(b) {
                    D(b)
                });
                ...
                B(a,
                function(b, c) { - 1 === a.getKeepProps().indexOf(c) && delete a[c]
                })
            };
    ...
    N(m, "Core/Axis/DateTimeAxis.js", [m["Core/Axis/Axis.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.addEvent,
        z = h.getMagnitude,
    ...
    N(m, "Core/Axis/LogarithmicAxis.js", [m["Core/Axis/Axis.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.addEvent,
        z = h.getMagnitude,
        F = h.normalizeTickInterval,
        ...
        K = function() {
            ...
            f.prototype.getLogTickPositions = function(f, e, h, v) {
                ...
                l = x.getLinearTickPositions(f, e, h);
                else if (.08 <= f) {
                    n = Math.floor(e);
                    var m, w;
    ...
    N(m, "Core/Axis/PlotLineOrBand.js", [m["Core/Axis/Axis.js"], m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        var z = m.arrayMax,
        F = m.arrayMin,
        P = m.defined,
        ...
        m = function() {
            ...
            f.prototype.render = function() {
                ...
                O.zIndex = x;
                u += "-" + x; (m = n.plotLinesAndBandsGroups[u]) || (n.plotLinesAndBandsGroups[u] = m = E.g("plot-" + u).attr(O).add());
                ...
                else return; ! f.eventsAdded && Q && (I(Q,
                function(b, a) {
                    B.on(a,
                    function(b) {
                        Q[a].apply(f, [b])
                    })
                }), f.eventsAdded = !0); (A || !B.d) && G && G.length ? B.attr({
                    d: G
        ...
        y(f.prototype, {
            ...
            removePlotBandOrLine: function(e) {
                ...
                n = this.options,
                l = this.userOptions,
                h = f.length; h--;) f[h].id === e && f[h].destroy(); [n.plotLines || [], l.plotLines || [], n.plotBands || [], l.plotBands || []].forEach(function(f) {
    ...
    N(m, "Core/Tooltip.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = f.doc,
        z = h.clamp,
        F = h.css,
        ...
        var w = function() {
            ...
            r.prototype.refresh = function(d, g) {
                ...
                if (a.enabled) {
                    ...
                    g = r[0];
                    var w = r[1]; ! p || q.series && q.series.noSharedTooltip ? p = q.getLabelConfig() : (c.pointer.applyInactiveState(q), q.forEach(function(a) {
                        a.setState("hover");
                    ...
                    c = f.call(p, this);
                    f = q.series;
                    this.distance = D(f.tooltipOptions.distance, 16); ! 1 === c ? this.hide() : (this.split ? this.renderSplit(c, n(d)) : (d = this.getLabel(), a.style.width && !l || d.css({
    ...
    N(m, "Core/Pointer.js", [m["Core/Color/Color.js"], m["Core/Globals.js"], m["Core/Tooltip.js"], m["Core/Utilities.js"]],
    function(f, h, m, z) {
        var F = f.parse,
        P = h.charts,
        K = h.noop,
        ...
        f = function() {
            ...
            g.prototype.normalize = function(c, a) {
                ...
                d = g.pageX - a.left;
                a = g.pageY - a.top;
                if (g = this.chart.containerScaling) d /= g.scaleX,
                a /= g.scaleY;
                return v(c, {
                    chartX: Math.round(d),
                    chartY: Math.round(a)
            ...
            g.prototype.onContainerMouseDown = function(c) {
                ...
                if ("undefined" === typeof c.button || a) this.zoomOption(c),
            ...
            g.prototype.onDocumentMouseMove = function(c) {
                ...
                var g = a.tooltip; ! d || g && g.isStickyOnContact() || a.isInsidePlot(c.chartX - a.plotLeft, c.chartY - a.plotTop) || this.inClass(c.target, "highcharts-tracker") || this.reset()
            };
            ...
            g.prototype.pinch = function(c) {
                ...
                E = {};
                1 < f && (a.initiated = !0);
                n && a.initiated && !m && !1 !== c.cancelable && c.preventDefault(); [].map.call(e,
                function(c) {
                    return a.normalize(c)
                });
                "touchstart" === c.type ? ([].forEach.call(e,
                function(a, b) {
                    g[b] = {
                        chartX: a.chartX,
                        chartY: a.chartY
            ...
            g.prototype.runPointActions = function(c, a) {
                ...
                if (f && (f !== d.hoverPoint || g && g.isHidden)) { (d.hoverPoints || []).forEach(function(a) { - 1 === n.indexOf(a) && a.setState()
                    });
                    if (d.hoverSeries !== l) l.onMouseOver();
                    this.applyInactiveState(n); (n || []).forEach(function(a) {
                        a.setState("hover")
                    });
                ...
                d.axes.forEach(function(a) {
                    ...
                    p;
                    g && ((p = d.hoverPoint) && p.series[a.coll] === a || (p = x(n,
                    function(c) {
            ...
            g.prototype.touch = function(c, a) {
                ...
                g;
                this.setHoverChartIndex();
                if (1 === c.touches.length) if (c = this.normalize(c), (g = d.isInsidePlot(c.chartX - d.plotLeft, c.chartY - d.plotTop)) && !d.openMenu) {
    ...
    N(m, "Core/MSPointer.js", [m["Core/Globals.js"], m["Core/Pointer.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        function z() {
            var e = [];
            e.item = function(e) {
        ...
        return function(f) {
            ...
            l.prototype.onContainerPointerDown = function(e) {
                F(e, "onContainerTouchStart", "touchstart",
                function(e) {
                    D[e.pointerId] = {
                        pageX: e.pageX,
                        pageY: e.pageY,
            ...
            l.prototype.onContainerPointerMove = function(e) {
                F(e, "onContainerTouchMove", "touchmove",
                function(e) {
                    D[e.pointerId] = {
                        pageX: e.pageX,
                        pageY: e.pageY
            ...
            l.prototype.onDocumentPointerUp = function(e) {
                F(e, "onDocumentTouchEnd", "touchend",
                function(e) {
                    delete D[e.pointerId]
                })
            };
            l.prototype.setDOMEvents = function() {
                f.prototype.setDOMEvents.call(this); (this.hasZoom || this.followTouchMove) && this.batchMSEvents(e)
            };
            return l
        } (h)
    });
    N(m, "Core/Legend.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        var z = f.animObject,
        F = f.setAnimation,
        L = m.addEvent,
        ...
        g = function() {
            ...
            c.prototype.init = function(a, c) {
                this.chart = a;
                this.setOptions(c);
                c.enabled && (this.render(), L(this.chart, "endResize",
                function() {
            ...
            c.prototype.destroyItem = function(a) {
                var c = a.checkbox; ["legendItem", "legendLine", "legendSymbol", "legendGroup"].forEach(function(c) {
                    a[c] && (a[c] = a[c].destroy())
                });
                c && y(a.checkbox)
            };
            c.prototype.destroy = function() {
                ...
                this.getAllItems().forEach(function(c) { ["legendItem", "legendGroup"].forEach(a, c)
                });
            ...
            c.prototype.renderItem = function(a) {
                ...
                this.colorizeItem(a, a.visible); ! c.styledMode && l.width || v.css({
            ...
            c.prototype.proximatePositions = function() {
                ...
                this.allItems.forEach(function(g) {
                    ...
                    if (g.yAxis) {
                        ...
                        g.points && (f = e(p ? g.points: g.points.slice(0).reverse(),
                        function(a) {
                            return x(a.plotY)
                        }));
            ...
            c.prototype.handleOverflow = function(a) {
                ...
                a > f && !1 !== v.enabled ? (this.clipHeight = h = Math.max(f - 20 - this.titleHeight - l, 0), this.currentPage = n(this.currentPage, 1), this.fullHeight = a, m.forEach(function(a, b) {
                    ...
                    g = t.length;
                    if (!g || c - t[g - 1] > h && (H || c) !== t[g - 1]) t.push(H || c),
                    g++;
                    a.pageIx = g - 1;
                    H && (m[b - 1].pageIx = g - 1);
                    ...
                    zIndex: 1
                }).add(this.group), this.up = g.symbol("triangle", 0, 0, b, b).add(k), x("upTracker").on("click",
                function() {
                    c.scroll( - 1, u)
                }), this.pager = g.text("", 15, 10).addClass("highcharts-legend-navigation"), d.styledMode || this.pager.css(v.style), this.pager.add(k), this.down = g.symbol("triangle-down", 0, 0, b, b).add(k), x("downTracker").on("click",
                function() {
                    c.scroll(1, u)
            ...
            return c
        } (); (/Trident\/7\.0/.test(d.navigator && d.navigator.userAgent) || m) && f(g.prototype, "positionItem",
        function(c, a) {
            var d = this,
            g = function() {
    ...
    function(f, h, m) {
        ...
        f = function() {
            ...
            f.prototype.destroy = function() {
                function e() {
                    if (d.graphic || d.dataLabel || d.dataLabels) l(d),
                    d.destroyElements();
                    for (p in d) d[p] = null
                }
                var d = this,
            ...
            f.prototype.firePointEvent = function(e, d, g) {
                var c = this,
                a = this.series.options; (a.point.events[e] || c.options && c.options.events && c.options.events[e]) && c.importEvents();
            ...
            f.prototype.optionsToObject = function(e) {
                ...
                else if (I(e)) for (!c && e.length > l && (g = typeof e[0], "string" === g ? d.name = e[0] : "number" === g && (d.x = e[0]), p++); n < l;) c && "undefined" === typeof e[p] || (0 < a[n].indexOf(".") ? f.prototype.setNestedProperty(d, e[p], a[n]) : d[a[n]] = e[p]),
                p++,
                n++;
            ...
            f.prototype.tooltipFormatter = function(e) {
                ...
                a = g.valuePrefix || "",
                f = g.valueSuffix || "";
                d.chart.styledMode && (e = d.chart.tooltip.styledModeFormat(e)); (d.pointArrayMap || ["y"]).forEach(function(d) {
                    d = "{point." + d;
    ...
    N(m, "Core/Series/Series.js", [m["Core/Globals.js"], m["Core/Series/Point.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        var z = m.error,
        F = m.extendClass,
        L = m.fireEvent,
        ...
        m = function() {
            ...
            f.cleanRecursively = function(h, m) {
                ...
                e(h,
                function(e, l) {
                    if (C(h[l], !0) && !h.nodeType && m[l]) e = f.cleanRecursively(h[l], m[l]),
    ...
    N(m, "Core/Chart/Chart.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Axis/Axis.js"], m["Core/Series/Series.js"], m["Core/Globals.js"], m["Core/Legend.js"], m["Core/MSPointer.js"], m["Core/Options.js"], m["Core/Pointer.js"], m["Core/Time.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F, L, K, C, y, e) {
        ...
        W = function() {
            ...
            f.prototype.redraw = function(a) {
                ...
                p && b.drawChartBox();
                G(b, "predraw");
                d.forEach(function(a) { (p || a.isDirty) && a.visible && a.redraw();
                    a.isDirtyData = !1
                });
                g && g.reset(!0);
                l.draw();
            ...
            f.prototype.layOutTitles = function(a) {
                ...
                this.titleOffset = b;
                G(this, "afterLayOutTitles"); ! this.isDirtyBox && g && (this.isDirtyBox = this.isDirtyLegend = g, this.hasRendered && H(a, !0) && this.isDirtyBox && this.redraw())
            };
            ...
            f.prototype.reflow = function(a) {
                ...
                if (!k && !b.isPrinting && f && d && (g === l || g === n)) {
                    if (f !== b.containerWidth || d !== b.containerHeight) e.clearTimeout(b.reflowTimeout),
            ...
            f.prototype.setReflow = function(a) {
                var b = this; ! 1 === a || this.unbindReflow ? !1 === a && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = w(l, "resize",
                function(a) {
            ...
            f.prototype.resetMargins = function() {
                ...
                b = a.options.chart; ["margin", "spacing"].forEach(function(c) {
                    var d = b[c],
                    g = E(d) ? d: [d, d, d, d]; ["Top", "Right", "Bottom", "Left"].forEach(function(d, k) {
                        a[c][k] = H(b[c + d], g[k])
                    })
                });
            ...
            f.prototype.drawChartBox = function() {
                ...
                if (f) var A = h = g.strokeWidth();
                    ...
                    if (A || g["stroke-width"]) p.stroke = a.borderColor,
                    p["stroke-width"] = A;
            ...
            f.prototype.propFromSeries = function() {
                ...
                g, k; ["inverted", "angular", "polar"].forEach(function(e) {
            ...
            f.prototype.render = function() {
                ...
                if (f || t) a.forEach(function(a) { (a.horiz && f || !a.horiz && t) && a.setTickInterval(!0)
                }),
                this.getMargins();
                this.drawChartBox();
            ...
            f.prototype.addCredits = function(a) {
                ...
                d.enabled && !this.credits && (this.credits = this.renderer.text(d.text + (this.mapCredits || ""), 0, 0).addClass("highcharts-credits").on("click",
                function() {
            ...
            f.prototype.firstRender = function() {
                ...
                if (!a.isReadyToRender || a.isReadyToRender()) {
                    ...
                    a.setChartSize();
                    a.propFromSeries();
                    a.getAxes(); (T(b.series) ? b.series: []).forEach(function(b) {
                        a.initSeries(b)
                    });
                    a.linkSeries();
                    a.setSeriesData();
    ...
    N(m, "Extensions/ScrollablePlotArea.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Chart/Chart.js"], m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h, m, z) {
        var F = f.stop,
        L = z.addEvent,
        K = z.createElement,
        ...
        h.prototype.moveFixedElements = function() {
            ...
            h.push(m, m + "-labels");
            h.forEach(function(h) { [].forEach.call(f.querySelectorAll(h),
                function(f) { (f.namespaceURI === e.SVG_NS ? e.box: e.box.parentNode).appendChild(f);
    ...
    N(m, "Core/Axis/StackingAxis.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Utilities.js"]],
    function(f, h) {
    ...
    N(m, "Mixins/LegendSymbol.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.merge,
        z = h.pick;
    ...
    N(m, "Core/Series/CartesianSeries.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Series/Series.js"], m["Core/Globals.js"], m["Mixins/LegendSymbol.js"], m["Core/Options.js"], m["Core/Series/Point.js"], m["Core/Renderer/SVG/SVGElement.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F, L, K, C) {
        ...
        },
        {
            ...
            bindAxes: function() {
                ...
                d = a.chart,
                e;
                g(this, "bindAxes", null,
                function() { (a.axisTypes || []).forEach(function(b) {
                        d[b].forEach(function(d) {
                            e = d.options;
                            if (c[b] === e.index || "undefined" !== typeof c[b] && c[b] === e.id || "undefined" === typeof c[b] && 0 === e.index) a.insert(d.series),
                            a[b] = d,
                            d.isDirty = !0
                        });
            ...
            setOptions: function(a) {
                ...
                c = this.zones = (f.zones || []).slice(); ! f.negativeColor && !f.negativeFillColor || f.zones || (d = {
            ...
            findPointIndex: function(a, c) {
                ...
                "undefined" === typeof q && p(g) && (q = this.xData.indexOf(g, c)); - 1 !== q && "undefined" !== typeof q && this.cropped && (q = q >= this.cropStart ? q - this.cropStart: q); ! e && k[q] && k[q].touched && (q = void 0);
                return q
            },
            ...
            setData: function(b, c, d, g) {
                ...
                t = b.length;
                c = M(c, !0);
                q && q.enabled && (b = this.sortData(b)); ! 1 !== g && t && f && !k.cropped && !k.hasGroupedData && k.visible && !k.isSeriesBoosting && (O = this.updateData(b, d));
                if (!O) {
                    k.xIncrement = null;
                    k.colorCounter = 0;
                    ...
                    if (n && t > n) if (n = k.getFirstValidPoint(b), p(n)) for (d = 0; d < t; d++) r[d] = this.autoIncrement(),
                    m[d] = b[d];
                    else if (a(n)) if (A) for (d = 0; d < t; d++) g = b[d],
                    r[d] = g[0],
                    m[d] = g.slice(1, A + 1);
                    else for (v && (E = v.indexOf("x"), H = v.indexOf("y"), E = 0 <= E ? E: 0, H = 0 <= H ? H: 1), d = 0; d < t; d++) g = b[d],
                    r[d] = g[E],
                    m[d] = g[H];
                    else w(12, !1, h);
            ...
            getProcessedData: function(a) {
                ...
                if (h && this.sorted && !l && (!p || d > p || this.forceCrop)) if (b[d - 1] < n || b[0] > u) b = [],
                c = [];
                ...
                for (p = b.length || 1; --p;) if (d = f ? a(b[p]) - a(b[p - 1]) : b[p] - b[p - 1], 0 < d && ("undefined" === typeof m || d < m)) var m = d;
            ...
            generatePoints: function() {
                ...
                this.options.keys = a;
                if (d && (h !== (e = d.length) || n)) for (m = 0; m < e; m++) m !== q || n || (m += h),
            ...
            getExtremes: function(b, c) {
                ...
                for (r = 0; r < k; r++) {
                    ...
                    if (A && m) if (A = w.length) for (; A--;) p(w[A]) && (f[l++] = w[A]);
                    else f[l++] = w
                }
                b = {
                    dataMin: x(f),
            ...
            translate: function() {
                ...
                for (m = 0; m < u; m++) {
                    ...
                    x.zone = this.zones.length && x.getZone(); ! x.graphic && this.group && f && (x.isNew = !0)
                }
            ...
            setClip: function(a) {
                ...
                if (!1 !== c.clip || a) this.group.clip(a || e ? l: b.clipRect),
            ...
            animate: function(a) {
                ...
                if (!b.hasRendered) if (a) this.setClip(c);
                else {
            ...
            destroy: function(a) {
                ...
                l;
                g(b, "destroy");
                this.removeEvents(a); (b.axisTypes || []).forEach(function(a) { (l = b[a]) && l.series && (J(l.series, b), l.isDirty = l.forceRedraw = !0)
                });
            ...
            getGraphPath: function(a, c, d) {
                ...
                p = [],
                h;
                a = a || b.points; (k = a.reversed) && a.reverse(); (e = {
                    right: 1,
                    center: 2
                } [e] || e && 3) && k && (e = 4 - e);
                ...
                a.forEach(function(k, q) {
                    var t = k.plotX,
                    n = k.plotY,
                    u = a[q - 1]; (k.leftCliff || u && u.rightCliff) && !d && (h = !0);
            ...
            render: function() {
                ...
                a.invertGroups(n); ! 1 === d.clip || a.sharedClipKey || l || u.clip(c.clipRect);
    ...
    N(m, "Series/LineSeries.js", [m["Core/Series/CartesianSeries.js"], m["Core/Globals.js"]],
    function(f, h) {
        h.Series = f;
        return h.Series
    });
    ...
    function(f, h, m, z, F) {
        ...
        h.prototype.getStacks = function() {
            ...
            e.series.forEach(function(h) {
                var l = h.xAxis && h.xAxis.options || {}; ! h.options.stacking || !0 !== h.visible && !1 !== e.options.chart.ignoreHiddenSeries || (h.stackKey = [h.type, I(h.options.stack, ""), f ? l.top: l.left, f ? l.height: l.width].join())
            })
        };
        z.compose(f);
        ...
        v.prototype.modifyStacks = function() {
            ...
            e[r + "Stacker"] && [f, "-" + f].forEach(function(d) {
                for (var g = m.length,
                c, a; g--;) if (c = m[g], w = e.getStackIndicator(w, c, e.index, d), a = (c = h[d] && h[d][c]) && c.points[w.key]) e[r + "Stacker"](a, c, g)
            })
        };
        ...
        v.prototype.getStackIndicator = function(e, f, h, m) { ! K(e) || e.x !== f || m && e.key !== m ? e = {
                x: f,
                index: 0,
                key: m
            }: e.index++;
    ...
    N(m, "Core/Dynamics.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Axis/Axis.js"], m["Core/Series/Series.js"], m["Core/Chart/Chart.js"], m["Core/Globals.js"], m["Series/LineSeries.js"], m["Core/Options.js"], m["Core/Series/Point.js"], m["Core/Time.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F, L, K, C, y, e) {
        var I = f.animate,
        v = f.setAnimation,
        x = m.seriesTypes,
        ...
        F.cleanRecursively = function(a, c) {
            ...
            G(a,
            function(b, g) {
                if (p(a[g], !0) && !a.nodeType && c[g]) b = F.cleanRecursively(a[g], c[g]),
        ...
        g(z.prototype, {
            ...
            update: function(a, d, g, b) {
                ...
                if (p = a.chart) {
                    ...
                    "alignTicks" in p && (m = !0);
                    G(p,
                    function(a, b) { - 1 !== e.propsRequireUpdateSeries.indexOf("chart." + b) && (h = !0); - 1 !== e.propsRequireDirtyBox.indexOf(b) && (e.isDirtyBox = !0); - 1 !== e.propsRequireReflow.indexOf(b) && (n ? e.isDirtyBox = !0 : l = !0)
                ...
                this.collectionsWithUpdate.forEach(function(b) {
                    if (a[b]) {
                        ...
                        Q(a[b]).forEach(function(a, d) {
                            ...
                            k && k.coll === b && (k.update(a, !1), g && (k.touched = !0)); ! k && g && e.collectionsWithInit[b] && (e.collectionsWithInit[b][0].apply(e, [a].concat(e.collectionsWithInit[b][1] || []).concat([!1])).touched = !0)
                        });
        ...
        g(C.prototype, {
            update: function(a, c, d, b) {
                ...
                q, l = f.chart,
                n = f.options;
                c = M(c, !0); ! 1 === b ? g() : e.firePointEvent("update", {
                    options: a
                },
                g)
            },
        ...
        g(L.prototype, {
            addPoint: function(a, d, g, b, e) {
                ...
                g && (k[0] && k[0].remove ? k[0].remove(!1) : (k.shift(), this.updateParallelArrays(u, "shift"), q.shift())); ! 1 !== e && c(this, "addPoint", {
                    point: u
                });
            ...
            remove: function(a, d, g, b) {
                ...
                var f = this,
                p = f.chart; ! 1 !== g ? c(f, "remove", null, e) : e()
            },
            update: function(a, e) {
                ...
                f.init(b, a);
                if (l && this.points) {
                    var B = f.options; ! 1 === B.visible ? (v.graphic = 1, v.dataLabel = 1) : f._hasPointLabels || (a = B.marker, k = B.dataLabels, a && (!1 === a.enabled || "symbol" in a) && (v.graphic = 1), k && !1 === k.enabled && (v.dataLabel = 1));
    ...
    N(m, "Series/AreaSeries.js", [m["Core/Series/Series.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Mixins/LegendSymbol.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F) {
        var L = h.parse,
        K = F.objectEach,
        C = F.pick,
        ...
        },
        {
            ...
            getStackPoints: function(e) {
                ...
                if (this.options.stacking) {
                    for (g = 0; g < e.length; g++) e[g].leftNull = e[g].rightNull = void 0,
                    l[e[g].x] = e[g];
                    K(n,
                    function(a, c) {
                    ...
                    h.forEach(function(a, e) {
                        var p = 0,
                        q, w;
                        if (l[a] && !l[a].isNull) f.push(l[a]),
                        [ - 1, 1].forEach(function(f) {
                            var p = 1 === f ? "rightNull": "leftNull",
                            m = 0,
                            v = n[h[e + f]];
                            if (v) for (g = y; 0 <= g && g < r;) q = v.points[g],
            ...
            getGraphPath: function(e) {
                ...
                for (n = 0; n < e.length; n++) {
                    ...
                    if (!a || h) h || c(n, n - 1, "left"),
                    a && !m && h || (z.push(e[n]), l.push({
                        x: n,
                        plotX: q,
                        plotY: p
                    })),
                ...
                n = f.call(this, z, !0, !0);
                l.reversed = !0;
                a = f.call(this, l, !0, !0); (p = a[0]) && "M" === p[0] && (a[0] = ["L", p[1], p[2]]);
                a = n.concat(a);
                f = f.call(this, z, !1, h);
                a.xMap = n.xMap;
                this.areaPath = a;
    ...
    N(m, "Series/SplineSeries.js", [m["Core/Series/Series.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.pick;
    ...
    N(m, "Series/AreaSplineSeries.js", [m["Core/Series/Series.js"], m["Mixins/LegendSymbol.js"], m["Core/Options.js"]],
    function(f, h, m) {
    ...
    N(m, "Series/ColumnSeries.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Series/Series.js"], m["Core/Color/Color.js"], m["Core/Globals.js"], m["Mixins/LegendSymbol.js"], m["Series/LineSeries.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F, L, K) {
        ...
        },
        {
            ...
            getColumnMetrics: function() {
                ...
                var a, h = {},
                p = 0; ! 1 === f.grouping ? p = 1 : e.chart.series.forEach(function(c) {
                    var d = c.yAxis,
                    f = c.options;
            ...
            adjustForMissingColumns: function(e, f, d, g) {
                ...
                if (!d.isNull && 1 < g.columnCount) {
                    var h = 0,
                    p = 0;
                    J(this.yAxis.stacking && this.yAxis.stacking.stacks,
                    function(g) {
    ...
    N(m, "Series/BarSeries.js", [m["Core/Series/Series.js"]],
    function(f) {
    ...
    N(m, "Series/ScatterSeries.js", [m["Core/Series/Series.js"], m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h, m) {
        m = m.addEvent;
        var z = h.Series;
        ...
        },
        {
            ...
            drawGraph: function() { (this.options.lineWidth || 0 === this.options.lineWidth && this.graph && this.graph.strokeWidth()) && z.prototype.drawGraph.call(this)
            },
            applyJitter: function() {
                var f = this,
                h = this.options.jitter,
                m = this.points.length;
                h && this.points.forEach(function(z, y) { ["x", "y"].forEach(function(e, C) {
    ...
    N(m, "Mixins/CenteredSeries.js", [m["Core/Globals.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.isNumber,
        z = h.pick,
        F = h.relativeLength,
        ...
        return f.CenteredSeriesMixin = {
            getCenter: function() {
                ...
                h = [z(v[0], "50%"), z(v[1], "50%"), z(D && 0 > D ? void 0 : h.size, "100%"), z(n && 0 > n ? void 0 : h.innerSize || 0, "0%")]; ! m.angular || this instanceof f.Series || (h[3] = 0);
                for (v = 0; 4 > v; ++v) D = h[v],
                m = 2 > v || 2 === v && /%$/.test(D),
    ...
    N(m, "Series/PieSeries.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Series/Series.js"], m["Mixins/CenteredSeries.js"], m["Core/Globals.js"], m["Mixins/LegendSymbol.js"], m["Series/LineSeries.js"], m["Core/Series/Point.js"], m["Core/Renderer/SVG/SVGRenderer.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F, L, K, C, y) {
        ...
        },
        {
            ...
            updateTotals: function() {
                ...
                this.total = g;
                for (d = 0; d < a; d++) f = c[d],
                f.percentage = 0 < g && (f.visible || !e) ? f.y / g * 100 : 0,
                f.total = g
            },
            generatePoints: function() {
            ...
            redrawPoints: function() {
                ...
                this.drawEmpty(); ! n || d.shadowGroup || e.styledMode || (d.shadowGroup = c.g("shadow").attr({
                    zIndex: -1
                }).add(d.group));
    ...
    N(m, "Core/Series/DataLabels.js", [m["Core/Animation/AnimationUtilities.js"], m["Core/Globals.js"], m["Core/Series/CartesianSeries.js"], m["Core/Utilities.js"]],
    function(f, h, m, z) {
        ...
        h.distribute = function(d, e, c) {
            ...
            d.some(function(a) {
                ...
                if (a.targets.some(function() {
                    ...
                    n.reducedLen = (n.reducedLen || e) - .1 * e,
                    n.reducedLen > .1 * e && h.distribute(n, e, c),
                    !0;
                    d += n[f].size;
                    f++
                })) return ! 0
            ...
            d.visible && (f.enabled || d._hasPointLabels) && (e.forEach(function(a) {
                ...
                if (n = l(W.connectorWidth, 1)) {
                    ...
                    if ((b = c.dataLabel) && b._pos && c.visible && 0 < c.labelDistance) {
                        ...
                        if (e = !z) c.connector = z = a.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + c.colorIndex + (c.className ? " " + c.className: "")).add(d.dataLabelsGroup),
                        a.styledMode || z.attr({
                            "stroke-width": n,
    ...
    N(m, "Extensions/OverlappingDataLabels.js", [m["Core/Chart/Chart.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.addEvent,
        z = h.fireEvent,
        F = h.isArray,
        ...
        m(f, "render",
        function() {
            var f = []; (this.labelCollectors || []).forEach(function(e) {
                f = f.concat(e())
            }); (this.yAxis || []).forEach(function(e) {
                e.stacking && e.options.stackLabels && !e.options.stackLabels.allowOverlap && K(e.stacking.stacks,
                function(e) {
                    K(e,
                    function(e) {
                        f.push(e.label)
        ...
        f.prototype.hideOverlappingLabels = function(f) {
            ...
            for (y = 0; y < h; y++) if (x = f[y]) x.oldOpacity = x.opacity,
            x.newOpacity = 1,
            x.absoluteBox = C(x);
            f.sort(function(d, e) {
            ...
            for (y = 0; y < h; y++) {
                ...
                for (x = y + 1; x < h; ++x) {
                    var r = (n = f[x]) && n.absoluteBox; ! w || !r || C === n || 0 === C.newOpacity || 0 === n.newOpacity || r.x >= w.x + w.width || r.x + r.width <= w.x || r.y >= w.y + w.height || r.y + r.height <= w.y || ((C.labelrank < n.labelrank ? C: n).newOpacity = 0)
                }
            }
            f.forEach(function(d) {
                if (d) {
                    var f = d.newOpacity;
                    d.oldOpacity !== f && (d.alignAttr && d.placed ? (d[f ? "removeClass": "addClass"]("highcharts-data-label-hidden"), l = !0, d.alignAttr.opacity = f, d[d.isOld ? "animate": "attr"](d.alignAttr, null,
                    function() {
                        e.styledMode || d.css({
    ...
    N(m, "Core/Interaction.js", [m["Core/Series/Series.js"], m["Core/Chart/Chart.js"], m["Core/Globals.js"], m["Core/Legend.js"], m["Series/LineSeries.js"], m["Core/Options.js"], m["Core/Series/Point.js"], m["Core/Utilities.js"]],
    function(f, h, m, z, F, L, K, C) {
        f = f.seriesTypes;
        var y = m.hasTouch,
        e = m.svg,
        ...
        m = m.TrackerMixin = {
            drawTrackerPoint: function() {
                ...
                a._hasTracking || (a.trackerGroups.forEach(function(f) {
                    if (a[f]) {
                        a[f].addClass("highcharts-tracker").on("mouseover", e).on("mouseout",
                        function(a) {
                            d.onTrackerMouseOut(a)
                        });
                        if (y) a[f].on("touchstart", e); ! c.styledMode && a.options.cursor && a[f].css(D).css({
        ...
        l(z.prototype, {
            setItemEvents: function(a, d, e) {
                ...
                l = f.chart.styledMode; (e ? [d, a.legendSymbol] : [a.legendGroup]).forEach(function(e) {
                    if (e) e.on("mouseover",
                    function() {
        ...
        l(h.prototype, {
            showResetZoom: function() {
                ...
                J(this, "beforeShowResetZoom", null,
                function() {
            ...
            zoom: function(a) {
                ...
                d, e = c.pointer,
                f = !1,
                h = c.inverted ? e.mouseDownX: e.mouseDownY; ! a || a.resetSelection ? (c.axes.forEach(function(a) {
                    d = a.zoom()
                ...
                if (! (a === this.state && !c || this.selected && "select" !== a || !1 === f.enabled || a && (n || h && !1 === p.enabled) || a && b.states && b.states[a] && !1 === b.states[a].enabled)) {
                    ...
                    if (this.graphic) {
                        ...
                        if (a && p) {
                            ...
                            else e && (d.stateMarkerGraphic = m = k.renderer.symbol(e, v.x, v.y, v.width, v.height).add(d.markerGroup), m.currentSymbol = e); ! k.styledMode && m && m.attr(d.pointAttribs(this, a))
                        }
        ...
        l(F.prototype, {
            ...
            onMouseOut: function() {
                ...
                c.hoverSeries = null;
                if (e) e.onMouseOut();
                this && a.events.mouseOut && J(this, "mouseOut"); ! d || this.stickyTracking || d.shared && !this.noSharedTooltip || d.hide();
            ...
            setVisible: function(a, c) {
                ...
                h = d.visible;
                var l = (d.visible = a = d.options.visible = d.userOptions.visible = "undefined" === typeof a ? !h: a) ? "show": "hide"; ["group", "dataLabelsGroup", "markerGroup", "tracker", "tt"].forEach(function(a) {
                    if (d[a]) d[a][l]()
                });
    ...
    N(m, "Core/Responsive.js", [m["Core/Chart/Chart.js"], m["Core/Utilities.js"]],
    function(f, h) {
        var m = h.find,
        z = h.isArray,
        F = h.isObject,
        ...
        f.prototype.setResponsive = function(f, h) {
            ...
            y = [],
            n = this.currentResponsive; ! h && v && v.rules && v.rules.forEach(function(f) {
        ...
        f.prototype.currentOptions = function(e) {
            function f(e, l, m, v) {
                ...
                K(e,
                function(d, e) {
                    if (!v && -1 < h.collectionsWithUpdate.indexOf(e)) for (d = y(d), m[e] = [], n = 0; n < Math.max(d.length, l[e].length); n++) l[e][n] && (void 0 === d[n] ? m[e][n] = l[e][n] : (m[e][n] = {},
                    f(d[n], l[e][n], m[e][n], v + 1)));
                    else F(d) ? (m[e] = z(d) ? [] : {},
                    f(d, l[e] || {},
                    m[e], v + 1)) : m[e] = "undefined" === typeof l[e] ? null: l[e]
                })
            }
            var h = this,
            m = {};
    ...
    N(m, "masters/highcharts.src.js", [m["Core/Globals.js"]],
    function(f) {
        return f
    });
